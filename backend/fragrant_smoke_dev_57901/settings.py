"""
Django settings for fragrant_smoke_dev_57901 project.
...
ROOT_URLCONF = 'fragrant_smoke_dev_57901.urls'
...
WSGI_APPLICATION = 'fragrant_smoke_dev_57901.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_smoke_dev_57901 API",
    "DESCRIPTION": "API documentation for fragrant_smoke_dev_57901 App",
    "VERSION": "v1",
}
